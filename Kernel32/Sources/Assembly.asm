...
section .text
    ...
    reloc: use32                               ; by Napalm
        ...
        mov  [REBASE(ib)], al                  ; set intrrupt immediate unsigned char from our arguments 
    ...
    r_mode16: use16
        ...
        db 0xCD                                ; opcode of INT instruction with immediate unsigned char
    ib: db 0x00
        cli                                    ; disable interrupts
    ...
    gdt16_base:                                ; GDT descriptor table
        ...
        .code32:                               ; 0x01 - 32bit code segment descriptor 0xFFFFFFFF
            ...
            db 0xCF                            ; 4Kunsigned char granularity, 32bit selector; limit 16:19
            db 0x00                            ; base  24:31
        ...
        .code16:                               ; 0x03 - 16bit code segment descriptor 0x000FFFFF
            ...
            db 0x00                            ; base  16:23
            db 0x9A                            ; present, iopl/0, code, execute/read
            db 0x0F                            ; 1unsigned char granularity, 16bit selector; limit 16:19
            db 0x00                            ; base  24:31
